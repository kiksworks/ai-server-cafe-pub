 ...
 */
public class TimeDijkstraHighQuality extends AbstractRangedExtendedDijkstra {
    protected TimeDijkstraHighQuality() {
        super("time-dijkstra-hq");
    }

    @Override
    protected double getThreshold() {
        return 1.6; // 計算によって求められた定数
    }
