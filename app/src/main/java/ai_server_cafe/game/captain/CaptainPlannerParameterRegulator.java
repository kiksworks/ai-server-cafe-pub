...
import ai_server_cafe.game.formation.FormationPlannerParameterRegulator;
...
public class CaptainPlannerParameterRegulator extends AbstractCaptain {
    public CaptainPlannerParameterRegulator(EnumCaptainType type, TeamColor color) {
        super(type, color);
    }

    @Override
    protected void setFormationMap(@Nonnull Map<EnumFormationType, Class<? extends AbstractFormation>> map) {
        map.put(EnumFormationType.FORCE_START, FormationPlannerParameterRegulator.class);
    }
